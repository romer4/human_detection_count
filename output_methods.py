...
class Methods_output:
    ...
    def video(self):
        writer = cv2.VideoWriter(
            r"./data_output/output.avi", cv2.VideoWriter_fourcc(*'MJPG'), 1, (600, 600))
        ...
        while video.isOpened():
            ...
            if check:
                ...
                cv2.putText(frame, f"Pessoas: {totalPersons}", (0, 25),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
                cv2.putText(frame, "FPS: {}".format(fps), (0, 50),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
                cv2.putText(frame, f"{round(delta * 1000, 2)}ms", (0, 75),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
